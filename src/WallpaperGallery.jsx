...
function WallpaperGallery() {
        ...
        return (
            <div className="relative" key={placeholder}>
                ...
                <a href={source.replace('../public', '')}
                    ...
                    font-bold  
                    px-1 py-1">
                    <svg className="w-5 mr-1 xl:w-6 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    if (Object.values(wallpapers).length % 2 === 0) {
        return (
        <>
            <div className="block lg:grid lg:grid-cols-2 2xl:grid-cols-4 gap-0">
                {wallpaperList}
            </div>
        </>
        )
    ...
    if (Object.values(wallpapers).length % 2 !== 0) {
        return (
        <>
            <div className="block lg:grid lg:grid-cols-3 gap-0">
                {wallpaperList}
            </div>
        </>
        )
